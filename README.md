...
Enhanced mSecure to Bitwarden import tool.

Unlike the built-in Bitwarden import tool, this script organizes secrets into meaningful folders instead of placing each secret in a separate folder.
